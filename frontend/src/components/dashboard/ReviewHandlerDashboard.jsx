...
function ReviewHandlerDashboard() {
    ...
    return (
        <div style={s.root}>
            <style>{`@media(max-width:600px){.rh-email{display:none}}`}</style>

            {/* Navbar */}
            <header style={s.navbar}>
                <div style={s.navLeft}>
                    <div style={{...s.logoBox, background:"transparent", padding:0}}><svg width="28" height="20" viewBox="0 0 28 20" xmlns="http://www.w3.org/2000/svg" style={{borderRadius:3,boxShadow:'0 1px 4px rgba(0,0,0,0.18)'}}>
                ...
                <div style={s.navRight}>
                    ...
                    <div style={s.userRow}>
                        ...
                        <span className="rh-email" style={s.email}>{user?.email||user?.mobile||"Review Handler"}</span>
                    </div>
...
const s = {
    ...
    main:{ maxWidth:1100,margin:"0 auto",padding:"clamp(12px,3vw,30px) clamp(12px,3vw,24px)" },
    cardRow:{ display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(130px, 1fr))",gap:18,marginBottom:26 },
    ...
    searchWrap:{ display:"flex",alignItems:"center",gap:10,flexWrap:"wrap",background:"#fff",borderRadius:12,padding:"10px 14px",marginBottom:18,boxShadow:"0 1px 3px rgba(0,0,0,0.06)" },
    ...
    tableWrap:{ background:"#fff",borderRadius:12,boxShadow:"0 1px 4px rgba(0,0,0,0.07)",overflowX:"auto" },
    tHead:{ display:"flex",alignItems:"center",padding:"12px 16px",borderBottom:"1px solid #e5e7eb",minWidth:620 },
    th:{ display:"flex",alignItems:"center",flex:1,fontSize:13,fontWeight:700,color:"#333" },
    tRow:{ display:"flex",alignItems:"center",padding:"14px 16px",borderBottom:"1px solid #f3f4f6",minWidth:620 },
...
export default ReviewHandlerDashboard;
