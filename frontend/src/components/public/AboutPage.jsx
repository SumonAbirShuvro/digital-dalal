...
const s = {
    ...
    navLinks: { display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' },
    ...
    /* Hero */
    hero: { background: '#e8f0e8', padding: 'clamp(20px,4vw,36px) clamp(16px,5vw,60px) 32px' },
    ...
    /* Info Cards */
    cardsSection: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: 0, background: '#c8d8c8', padding: '0' },
    ...
    /* Banner */
    banner: { background: '#fefce8', border: '1px solid #fde68a', margin: 'clamp(16px,3vw,28px) clamp(12px,4vw,40px)', borderRadius: 14, padding: 'clamp(16px,3vw,24px) clamp(16px,3vw,28px)', display: 'flex', alignItems: 'center', gap: 28, flexWrap: 'wrap' },
    bannerLeft: { display: 'flex', alignItems: 'center', gap: 14, minWidth: 200, flexShrink: 0 },
    ...
    /* How we work */
    howSection: { padding: 'clamp(24px,4vw,40px) clamp(16px,5vw,60px) clamp(24px,4vw,48px)', textAlign: 'center' },
    howTitle: { fontSize: 28, fontWeight: 800, color: '#111', marginBottom: 8 },
    howSub: { fontSize: 14, color: '#6b7280', marginBottom: 32 },
    stepsRow: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(140px, 1fr))', gap: 20 },
