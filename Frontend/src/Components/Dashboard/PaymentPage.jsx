...
const PaymentPage = () => {
    ...
    const handlePay = async () => {
        ...
        try {
            // Call backend to initiate payment → get UddoktaPay URL
    ...
    return (
        <div style={{ fontFamily: "'Segoe UI',system-ui,sans-serif", background: '#f0f4f3', minHeight: '100vh' }}>
            ...
            <div style={{ maxWidth: 900, margin: '24px auto', padding: '0 24px 48px', display: 'grid', gridTemplateColumns: '1fr 340px', gap: 24, alignItems: 'start' }}>
                ...
                <div>
                    ...
                    {/* Card info — UddoktaPay handles card on their page */}
                    {selectedMethod === 'card' && (
