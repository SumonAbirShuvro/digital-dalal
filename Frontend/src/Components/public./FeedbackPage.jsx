...
const s = {
    ...
    navbar: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: 'white', padding: '10px 28px', borderBottom: '1px solid #e5e7eb', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', cursor: 'pointer' },
    navLeft: { display: 'flex', alignItems: 'center', gap: 10 },
    logoBox: { width: 36, height: 36, background: '#166534', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' },
    appName: { fontWeight: 700, fontSize: 15, color: '#111' },
    appSub: { fontSize: 11, color: '#888' },
    backBtn: { background: 'none', border: '1.5px solid #d1d5db', borderRadius: 8, padding: '7px 16px', fontSize: 13, fontWeight: 600, color: '#374151', cursor: 'pointer' },
    main: { flex: 1, display: 'flex', justifyContent: 'center', padding: '40px 20px' },
    formCard: { background: 'white', borderRadius: 20, padding: '36px 40px', maxWidth: 560, width: '100%', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' },
    successCard: { background: 'white', borderRadius: 20, padding: '60px 40px', maxWidth: 480, width: '100%', textAlign: 'center', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' },
    formHeader: { display: 'flex', alignItems: 'center', gap: 14, marginBottom: 24, paddingBottom: 20, borderBottom: '1px solid #f3f4f6' },
    ...
    input: { width: '100%', padding: '11px 14px', border: '1.5px solid #e5e7eb', borderRadius: 10, fontSize: 14, color: '#374151', background: 'white', outline: 'none', boxSizing: 'border-box', fontFamily: "'Segoe UI','Noto Sans Bengali',sans-serif" },
    errText: { fontSize: 12, color: '#ef4444', marginTop: 4 },
    submitBtn: { width: '100%', padding: '14px', background: 'linear-gradient(135deg,#166534,#15803d)', color: 'white', border: 'none', borderRadius: 12, fontSize: 15, fontWeight: 700, cursor: 'pointer', boxShadow: '0 4px 14px rgba(22,101,52,0.25)' },
    footer: { background: 'white', borderTop: '1px solid #e5e7eb', padding: '12px 28px', display: 'flex', justifyContent: 'space-between', fontSize: 13, color: '#555' },
};
